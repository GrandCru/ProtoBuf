...
This file will be overwritten when CodeGenerator is run.");
            ...
            {
                // .Interfaces.cs
                using (var cw = new CodeWriter(prefix + ".Interfaces" + ext))
                {
                    cw.Comment(@"This is the code for interfaces for messages");
                    cw.WriteLine();
                    cw.Comment(@"Generated by ProtocolBuffer
- a pure c# code generation implementation of protocol buffers
Report bugs to: https://github.com/muhmi/ProtoBuf");
                    cw.WriteLine();
                    cw.Comment(@"DO NOT EDIT
This file will be overwritten when CodeGenerator is run.");
                    cw.WriteLine();
                    ...
                    foreach (ProtoMessage m in file.Messages.Values)
                    {
                        ...
                        MessageCode.GenerateInterface(m, cw, options);
                        cw.WriteLine();
                    }
